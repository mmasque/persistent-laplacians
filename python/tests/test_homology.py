...
def test_rust_vs_gudhi(n, d, r, noise, seed):
    boundary_matrices, boundary_maps_index_dict, unique_filtration_values, st = (
        sphere_data(n, d, r, noise, seed)
    )
